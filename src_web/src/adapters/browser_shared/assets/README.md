...
On 2026-09-10 the assets moved unchanged to `browser_shared/assets`, shared by
the archived and replacement browser. Historical `../` code references below
refer to `browser_legacy`. New `browser/map/art.ts` contains original geometric
crate/case, bottle, document, bench and abstract nonhuman resident markers,
