...
import fallback from "../browser_shared/assets/folder.svg";
import resident from "../browser_shared/assets/site-999.svg";
import camera from "../browser_shared/assets/camera.svg";
