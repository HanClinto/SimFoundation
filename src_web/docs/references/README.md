...
For the 2026-09-09 adaptation draft, see the [ranked expedition proposals](../scp-expedition-proposals.md) covering all 59 distinct archived works and the [priority and subsystem brief](../scp-expedition-priorities.md). These are design proposals, not implemented gameplay or additions to the source snapshots.
