...
Tactical Response retains duty controls and condition reporting; Control on Map selects and centers its responder without issuing work, drafting or clearing the queue. Personal Move/Hold/Retreat/Engage/Stabilize commands live on the map rather than this inspector. Recorded inspection retains Locate, but control handoff requires World view and no active placement. Expedition personal/recovery commands still use legacy ownership takeover and can clear the manual queue; their migration is tracked in [control usability TODOs](control-usability-todos.md). Map Do Now preserves pending intentions. Field-map adapters delegate to the root controller. Object relocation remains a worker-owned logistics job rather than a pawn intention. Inspection alone, subject switching, Follow and Recorded-view changes do not take ownership or alter queues.
