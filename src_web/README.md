...
Once eating, sleeping or relaxing begins at the furniture, the current tile shows progress and an approximate remaining time in **in-game minutes**, assuming no interruption. Sleep uses net rest recovery toward95; Eat and Relax use their fixed activity durations. Pending orders, travel and blocked actions do not show a speculative countdown. Progress is also shown for automatic routines and remains frozen while paused. No save-version change is needed.
