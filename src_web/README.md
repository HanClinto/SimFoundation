...
The fixed laboratory-annex prototype is retired from new-game controls. Engineering builds and removes individual surfaces; Objects and Supplies handles furniture. Saves containing old annex projects retain **Engineering > Legacy annex projects** for Locate and safe pre-dispatch cancellation, and already-authorized work can finish without losing reserved materials. The legacy commissioning task does not produce research findings.
